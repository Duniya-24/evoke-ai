          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-3 text-muted-foreground hover:text-primary smooth-transition"
                  >
              ...
              <div className="flex items-center justify-between">
                ...
                <Link to="#" className="text-sm text-primary hover:text-primary-glow smooth-transition">
                  Forgot password?
                </Link>
              </div>

              <Button type="submit" className="w-full bg-gradient-primary hover:shadow-glow smooth-transition">
                Sign In
              </Button>
            </form>
